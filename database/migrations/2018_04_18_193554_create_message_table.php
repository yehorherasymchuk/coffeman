...
class CreateMessageTable extends Migration
{
    public function up()
    {
        Schema::create('message', static function (Blueprint $table) {
            ...
            $table->longText('caption_entities')->nullable();
            $table->longText('animation')->nullable();
            $table->longText('game')->nullable();
            $table->longText('poll')->nullable();
            $table->longText('invoice')->nullable();
            $table->longText('successful_payment')->nullable();
            $table->longText('passport_data')->nullable();
            $table->longText('reply_markup')->nullable();
            $table->text(
                'new_chat_members',
                65535
