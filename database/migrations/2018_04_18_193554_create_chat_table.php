...
class CreateChatTable extends Migration
{
    public function up()
    {
        Schema::create('chat', static function (Blueprint $table) {
            ...
            $table->char('last_name')->nullable()->comment('User\'s last name');$table->boolean('all_members_are_administrators')->nullable()->default(0)->comment('True if a all members of this group are admins');
            $table->timestamps();
